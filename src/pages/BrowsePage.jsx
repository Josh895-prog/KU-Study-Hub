    ...
    <div className="browse-page">
      ...
      >
        ...
        {courses.slice(0, 6).map((c) => (
          <button
            key={c.id}
            onClick={() => setSearchTerm(c.code)}
            style={{
              padding: "0.3rem 0.75rem",
              borderRadius: "var(--radius-full)",
              background: searchTerm === c.code ? "var(--ku-maroon)" : "rgba(255, 255, 255, 0.06)",
              border: `1px solid ${searchTerm === c.code ? "var(--ku-gold)" : "var(--border-color)"}`,
              color: searchTerm === c.code ? "#ffffff" : "var(--text-muted)",
              fontSize: "0.8rem",
              fontWeight: 600,
              cursor: "pointer",
              whiteSpace: "nowrap"
